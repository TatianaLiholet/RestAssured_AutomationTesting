...
import com.herokuapp.restFull.Booking;
import com.herokuapp.restFull.Bookingdates;
...
public class CreateBookingTest extends BaseTest{
    ...
    public void createBookingWithPOJOTest(){
        ...
        Booking  booking = new Booking("Tetiana", "Testing", 345, false, bookingdates, "Breakfast");
        Response response = RestAssured.given().contentType(ContentType.JSON).
                body(booking.toString()).post("https://restful-booker.herokuapp.com/booking");
